...
a_plus_emove_nfa :: Nfa Int
a_plus_emove_nfa =
                 NFA (Set.fromList [0,1]) (Set.fromList [Move 0 'a' 1, Move 1 'a' 1]) 0 (Set.fromList [1])

simple_or_result :: Nfa Int
simple_or_result =
